...
const MobileApp = () => {
  return (
    <div className="mx-4 mb-32 grid justify-between gap-6 rounded-36 bg-white md:mx-auto md:w-2/3 md:grid-cols-2 md:gap-10 md:p-10 md:pr-0 md:pb-0">
      <div className="px-2 py-6 md:p-0">
      ...
      <div className="order-first -mt-20 flex justify-end md:-order-none">
        <img
          src={appImg}
          alt="Mobile App"
          className="h-[300px] rounded-br-36 md:h-[400px]"
        />
      </div>
    </div>
  );
