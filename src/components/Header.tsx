...
const Header = () => {
  return (
    <>
      <div className="grid items-center md:grid-cols-5 md:pl-20">
        <header className="col-span-2 pl-4 pr-2 md:pr-10">
          ...
          >
            <div className="flex max-w-[80%] items-center justify-between gap-2 md:max-w-none md:justify-start md:gap-6">
              <Mail />
              <input
                id="email"
                type="email"
            ...
            <button
              type="submit"
              className="min-w-max rounded-20 bg-primary px-3 py-2 font-poppins text-xs font-medium text-white md:min-w-fit md:px-8 md:py-4 md:text-base"
            >
              Get Started
            </button>
          </label>
      ...
      <div className="relative mt-20 flex flex-col items-center justify-center px-1 font-inter md:flex-row">
        <Arrow className="absolute top-20 right-20 w-28 md:left-28 md:-top-[220px] md:w-auto" />
        <span className="mb-2 text-base font-medium text-primary md:mb-0">
          Everything is easy!
        </span>
        <ol className="flex flex-col items-center gap-y-1 text-sm text-text md:ml-16 md:flex-row md:gap-x-14 md:text-base">
          {[
            "Post a Task",
